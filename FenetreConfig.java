...
public class FenetreConfig extends JFrame implements Constantes,ActionListener
{
    ...
    private JButton[] JAdd1 = {new JButton("Ajouter une ouvriere bleue"), new JButton("Ajouter une guerriere bleue")};
    private JButton[] JAdd2 = {new JButton("Ajouter une ouvriere rouge"), new JButton("Ajouter une guerriere rouge")};
    private JButton JBombe = new JButton("21 Dec. 2012");
	...
	JBombe.setBounds((LONG_CFG/2)-60,550,120,25);
	// ---------- bouttons de changement de decor
	JDecor[0].setBounds(40,450,75,35);
	JDecor[1].setBounds(150,450,75,35);
	// ---------- bouttons d'agrandissement / diminution du nuage de phéromones
	JStade[0].setBounds((LONG_CFG/2)-90,350,180,25);
	JStade[1].setBounds((LONG_CFG/2)-90,380,180,25);
	// -------------------- Label ou est indique la taille du nuage de pheromones 
	tailleNuage.setBounds((LONG_CFG/2),395,40,40);
