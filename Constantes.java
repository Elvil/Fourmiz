...
interface Constantes
{
    ...
    public static final int LONG_CFG = 250;
    ...
    public static final int TAILLE_PLANTE = 20;
    // Duree de vie d une pheromone
    public static final int DUREE_VIE_PHERO = 50;
    // Couleurs possibles pour les fourmilieres
    public static final Color[] COLOR_FOURMILIERE = { new Color(255,0,0,250), new Color(0,0,255,250)};
}